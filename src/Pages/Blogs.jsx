              ...
              <ul className="inline-flex overflow-hidden rounded-lg border border-stroke dark:border-gray">
                ...
                <li>
                  ...
                  >
                    ...
                    >
                      <path
                        d="M2.5 9.8125H15.8438L10.5312 4.40625C10.25 4.125 10.25 3.6875 10.5312 3.40625C10.8125 3.125 11.25 3.125 11.5312 3.40625L18 9.96875C18.2812 10.25 18.2812 10.6875 18 10.9688L11.5312 17.5312C11.4062 17.6562 11.2188 17.75 11.0312 17.75C10.8438 17.75 10.6875 17.6875 10.5312 17.5625C10.25 17.2812 10.25 16.8438 10.5312 16.5625L15.8125 11.2188H2.5C2.125 11.2188 1.8125 10.9062 1.8125 10.5312C1.8125 10.125 2.125 9.8125 2.5 9.8125Z"
                        fill="currentColor"
                      />
                    </svg>
                  </button>
