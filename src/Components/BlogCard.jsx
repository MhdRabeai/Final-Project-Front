...
const BlogCard = ({ id, date, CardTitle, CardDescription, image, doctorName }) => {  
  return (  
        ...
        <div className="w-full mx-auto rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 dark:bg-gray-900 bg-white transition-transform transform hover:scale-105 flex flex-col">  
          ...
          <div className="p-6 flex flex-col flex-grow">  
            <div className="flex items-center mb-4">  
              <div className="border border-gray-300 dark:border-gray-600 p-2 rounded mr-3 bg-[#4F9451]">  
                <span className="text-sm text-white dark:text-gray-400 ">  
                  {date}  
                </span>  
              </div>  
              <span className="text-gray-700 border border-gray-300 dark:border-gray-600 p-2 rounded mr-3 bg-[#4F9451] text-white">{doctorName}</span>  
            </div>  
