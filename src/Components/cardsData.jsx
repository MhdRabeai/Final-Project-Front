...
const cardsData = [
    {
      ...
      content: "Access licensed therapists from the comfort of your home through secure video sessions. Personalized support is just a click away. Don't hesitate and start right now!",
      icon: faComments,
    },
    {
