...
const Footer = () => {
  return (
    <footer class="bg-[#4f9451] w-full mt-10 rounded-t-3xl">
      <div class="mt-auto w-full max-w-[85rem] py-8 px-5  mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4  justify-between gap-6 md:gap-1">
          ...
          <div class="col-span-1">
            ...
            <div class="mt-3 grid space-y-3 text-md">
              ...
              <p class="inline-flex gap-x-2 text-gray-300 focus:outline-none focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200">
                Email: <span>hopehorizon@gmail.com</span>
              </p>
            </div>
          </div>
        </div>

        <div class="pt-2 mt-3 sm:mt-6 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center border-t border-gray-200 ">
          <div class="flex justify-between items-center">
            <p class="text-sm text-gray-100 ">© 2024 B4F.</p>
          </div>
