...
const Footer = () => {
  return (
    ...
    <footer class="relative overflow-hidden bg-[#4f9451] mt-10 rounded-t-3xl">
      <svg
      ...
      <div class="relative z-10">
        <div class="w-full max-w-5xl px-4 xl:px-0 py-4 lg:pt-6 mx-auto flex justify-center">
          <div class="inline-flex items-center border-x px-5 mx-5">
            <Link to={"/"}>
